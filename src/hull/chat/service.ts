...
/** Widget columns + the raiser's handle — one projection for both list reads. */
const widgetViewColumns = {
  id: chatWidgets.id,
 ...
 */
async function emitWidgetChanged(
  db: Database,
 ...
 */
async function visibleWidget(db: Database, id: string): Promise<ChatWidgetRow> {
